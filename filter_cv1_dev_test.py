...
mixed['wav_filename'] = '/snakepit/shared/data/mozilla/CommonVoice/v2.0-alpha1.0/{}/'.format(LOCALE) + mixed['wav_filename'].astype(str)
mixed['transcript'] =  mixed['transcript'].str.replace(u'\xa0', ' ')


print("mixed[train_indices].head():")
print(mixed[train_indices].head())
...
print("os.path.join(output_folder, 'cv_{}_valid_train.csv'.format(LOCALE)):")
print(os.path.join(output_folder, 'cv_{}_valid_train.csv'.format(LOCALE)))
